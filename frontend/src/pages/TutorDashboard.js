...
const TutorDashboard = ({ initialView = 'dashboard' }) => {
        ...
        const DashboardView = () => ( <
            ...
            animate = {
                { opacity: 1, y: 0 } }
            className = "max-w-7xl mx-auto space-y-8" > { /* Welcome Header */ } <
            ...
            className = "text-indigo-600 text-sm font-bold" > View Full Schedule < /button> <
            /div> <
            div className = "divide-y divide-slate-50" > {
                upcomingLessons.length > 0 ? upcomingLessons.map(lesson => ( <
                    ...
                    p className = "text-sm text-slate-500" > Course: { lesson.course }• { lesson.students }
                    enrolled < /p> <
                    /div> <
                    /div> <
        ...
        return ( <
                div className = "flex min-h-screen bg-slate-50 font-sans" > { /* Sidebar */ } <
                ...
                className = "lg:hidden text-slate-400 hover:text-white" > < X className = "h-6 w-6" / > < /button> <
                /div>
                ...
                className = "lg:hidden p-2 text-slate-600" > { isSidebarOpen ? < X className = "h-6 w-6" / > : < Menu className = "h-6 w-6" / > } <
                /button>
                ...
                Bell className = "h-5 w-5" / > {
                    unreadNotifications > 0 && ( <
                        span className = "absolute -top-1 -right-1 min-w-5 h-5 px-1 bg-rose-500 text-white rounded-full border-2 border-white text-[10px] font-bold flex items-center justify-center" > { unreadNotifications > 9 ? '9+' : unreadNotifications } <
                        /span>
                    )
                } <
                /button>
                ...
                AnimatePresence > {
                            ...
                            notifications.length === 0 ? ( <
                                p className = "px-4 py-6 text-sm text-slate-500 text-center" > No notifications yet < /p>
                                    ...
                                    notifications.map((item) => ( <
                                        ...
                                        /div> {
                                            !item.isRead && < span className = "w-2.5 h-2.5 rounded-full bg-indigo-600 mt-1" > < /span>} <
                                                /div> <
                                                p className = "text-[10px] text-slate-400 mt-1 font-semibold uppercase tracking-wide" > { getNotificationTime(item.createdAt) } < /p> <
                                                /button>
                                        )))
                                } <
                                /div> <
                    ...
                    AnimatePresence > {
                        profileDropdown && ( <
                            ...
                            div className = "p-1 border-t border-slate-50" > < button onClick = { handleLogout }
                            className = "w-full flex items-center space-x-3 px-3 py-2 text-sm text-rose-600 hover:bg-rose-50 rounded-xl" > < LogOut className = "h-4 w-4" / > < span > Sign Out < /span></button > < /div> <
                            /motion.div>
                        )
                    } <
                    /AnimatePresence> <
