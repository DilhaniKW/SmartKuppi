...
import { 
  Plus, Clock, Video, Users, 
  ChevronLeft, X, 
  CheckCircle, Calendar as CalendarIcon,
  MoreVertical, MessageSquare, ExternalLink
} from 'lucide-react';
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                {selectedDayLessons.length} Lessons
              </span>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold">
                  {lessons.reduce((total, l) => total + parseInt(l.duration), 0) / 60} hrs
                </span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
            ...
            >
              <div className="p-6 border-b border-slate-50 flex items-center justify-between">
                ...
                <button onClick={() => setShowLessonDetails(false)} className="p-2 hover:bg-slate-50 rounded-xl transition-colors">
                  <X className="h-5 w-5 text-slate-400" />
                </button>
              </div>
