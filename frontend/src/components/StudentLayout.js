...
const StudentLayout = ({ children, title, showSearch = true }) => {
        ...
        return ( <
            ...
            <
            div className = "w-10 h-10 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold border border-indigo-400" > { getInitials() } <
            /div> <
            ...
            { /* Main Content */ } <
            div className = "flex-1 flex flex-col min-w-0 overflow-hidden" > { /* Header */ } <
            ...
            AnimatePresence > {
                ...
                <
                div className = "w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center text-white font-bold text-xs" > { getInitials() } <
                /div> <
                ...
                { /* Page Content */ } <
                main className = "flex-1 overflow-y-auto p-4 sm:p-8" > { children } <
                /main>
